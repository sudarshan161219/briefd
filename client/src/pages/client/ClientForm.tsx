  ...
  return (
    <div className={styles.root}>
      ...
      {!isSubmitted ? (
          ...
          <div className={styles.section}>
            ...
            <div className={styles.field}>
              ...
              <p className={styles.hint}>
                e.g. Generate more leads, automate a manual process, modernize
                our brand.
              </p>
              <input
                className={styles.input}
        ...
        <div id="success-view" className={styles.success}>
          <div className={styles.successMark}>✓</div>
          <h2 className={styles.successTitle}>Brief submitted.</h2>
          <p className={styles.successText}>
            The freelancer has received your requirements and will be in touch
            soon.
          </p>
        </div>
      )}
